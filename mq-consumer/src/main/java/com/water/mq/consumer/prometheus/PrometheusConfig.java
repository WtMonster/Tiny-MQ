package com.water.mq.consumer.prometheus;
...
public class PrometheusConfig {
    ...
    static {
        ...
        micrometerRegistry.config().commonTags("application", "mq-consumer", "instance", "localhost:8002");
    ...
    public static void init() {
        try {
            new HTTPServer(new InetSocketAddress(8002), REGISTRY);
        } catch (IOException e) {
